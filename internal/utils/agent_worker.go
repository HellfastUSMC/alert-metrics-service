...
func Worker(sendMetrics func(keyPath string, serverAddress string) error, log logger.CLogger, errorsList []any, intervals []int, keyPath string, serverAddress string) error {
